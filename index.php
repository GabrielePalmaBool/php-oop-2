...
<ul>
    ...
    <li>
        ...
        <h2> Per: <?php echo $toys ->getBrand();?></h2>
        <h2> Data di scadenza: <?php echo $toys ->getTarget();?></h2>
        <h2> Nome Azienda: <?php echo $toys ->getMaterial();?></h2>
        <h2> Sede Azienda: <?php echo $toys ->getCompName();?></h2>
    </li>
